...
# Violation severity and penalty points
# Violation severity and penalty points
VIOLATION_PENALTIES = {
    ViolationType.PARKING_NO_PARKING: {"points": 5, "fine": 2500.0, "severity": "low"},
    ViolationType.PARKING_NO_STOPPING: {"points": 10, "fine": 5000.0, "severity": "medium"},
    ViolationType.PARKING_OVERTIME: {"points": 3, "fine": 1500.0, "severity": "low"},
    ViolationType.PARKING_HANDICAP: {"points": 20, "fine": 15000.0, "severity": "high"},
    ViolationType.PARKING_LOADING: {"points": 7, "fine": 3000.0, "severity": "low"},
}
...
if __name__ == "__main__":
    ...
    # Driver 2: Parking violations
    driver2, _ = engine.record_violation("XYZ-5678", ViolationType.PARKING_NO_PARKING)
    ...
    # Driver 3: Handicap violations
    driver3, _ = engine.record_violation("BAD-0000", ViolationType.PARKING_HANDICAP)
    driver3, _ = engine.record_violation("BAD-0000", ViolationType.PARKING_HANDICAP)
