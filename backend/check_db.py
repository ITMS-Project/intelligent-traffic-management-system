...
DB_PATH = BACKEND_DIR / "traffic.db"
...
def check_database():
    ...
    try:
        ...
        print_header("VIOLATIONS (Last 5)")
        ...
        try:
            ...
            if violations:
                ...
                print("   Tip: Let a vehicle sit in a parking zone for 15+ seconds.")
        except sqlite3.OperationalError as e:
            print(f"   ⚠️ Violations table issue: {e}")
            print("   The violations may be stored in a different format.")
        ...
        try:
            ...
            for table_name in ['driver_scores', 'scores', 'users']:
                try:
